	...
	public static String decodeTheCode(String s) {
		...
		for(int i =0; i<s.length(); i++) {
			...
			if (Character.isAlphabetic(s.charAt(i)) || s.charAt(i)==' ') {
				...
				str=str+s.charAt(i);
				//after here, if we said return str; and we printed we would have 
				//String str1="One Two five Six"; and String str2="Nine Three four";
				//thats why we can now split those strings and have arrays
			}
		}
